...
export const IDPApplication = () => {
    ...
    if (submitSuccess) {
        return (
            <div className="max-w-4xl mx-auto p-8 bg-green-50 rounded-lg shadow-md">
                <h2 className="text-2xl font-bold text-green-700 mb-4">Application Submitted Successfully!</h2>
                <p className="mb-4">Your IDP application has been received.</p>
                <button
                    onClick={() => {
    ...
    return (
        <div className="max-w-4xl mx-auto p-6">
            <h1 className="text-2xl font-bold mb-6">International Driving Permit Application</h1>
